...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infrastructure.FieldData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Infrastructure.FileConversionHistoryData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Infrastructure.MappingFieldData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Infrastructure.UrlConversionHistoryData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Infrastructure.UrlFileGettingData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Infrastructure.FieldData", b =>
                {
                    b.HasOne("Infrastructure.FieldData", "ParentField")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Infrastructure.MappingFieldData", b =>
                {
                    ...
                    b.HasOne("Infrastructure.FieldData", "SourceField")
                        .WithMany()
                        .HasForeignKey("SourceFieldId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Infrastructure.FieldData", "TargetField")
                        .WithMany()
