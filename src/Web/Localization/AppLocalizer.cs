        ...
        private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> Resources =
            new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
            {
                ["uk"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
                {
                    ...
                    ["PasswordChangeFailed"] = "Не вдалося змінити пароль. Перевірте поточний пароль і вимоги до нового пароля.",
                    ["PasswordConfirmationMismatch"] = "Підтвердження пароля не збігається.",
                    ["UserNotFound"] = "Користувача не знайдено.",
                    ["CreateUser"] = "Створити користувача",
                    ["ExistingUsers"] = "Наявні користувачі",
                    ["UserCreated"] = "Користувача створено.",
                    ["UserName"] = "Ім'я користувача",
                    ["Role"] = "Роль",
                    ["GrantAdministrator"] = "Надати права адміністратора",
                    ...
                    ["TransformationCompleted"] = "Трансформацію завершено.",
                    ["OpenLatestResult"] = "Відкрити результат",
                    ["CopyLink"] = "Скопіювати посилання",
                    ["CopyStableLink"] = "Скопіювати постійне посилання",
                    ...
                    ["TelemetryLogs"] = "Телеметричні логи",
                    ["MinimumLogLevel"] = "Мінімальний рівень",
                    ["Refresh"] = "Оновити",
                    ["Clear"] = "Очистити",
                    ["NewestLogs"] = "Найновіші",
                    ["NewerLogs"] = "Новіші",
                    ["OlderLogs"] = "Старіші",
                    ["Page"] = "Сторінка",
                    ["Entries"] = "записів",
                    ...
                    ["Trace"] = "Трасування",
                    ["NoLogsCaptured"] = "Для обраного рівня логів поки немає.",
                    ["Exception"] = "Виняток",
                    ["Error"] = "Помилка",
                    ["RequestId"] = "ID запиту",
                ...
                ["en"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
                {
                    ...
                    ["PasswordChangeFailed"] = "Could not change password. Check the current password and new password requirements.",
                    ...
                    ["UserName"] = "User name",
                    ["Role"] = "Role",
                    ["GrantAdministrator"] = "Grant administrator rights",
                    ...
                    ["Message"] = "Message",
                    ["Trace"] = "Trace",
                    ["NoLogsCaptured"] = "No logs captured for the selected level.",
                    ["Exception"] = "Exception",
                    ["Error"] = "Error",
